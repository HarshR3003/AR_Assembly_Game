The aim of the project is to build an Assembly game using AR. The object consists of 9 blocks assembled like a rubix cube. It uses a tap to place button functionality and transform function of C# to 
